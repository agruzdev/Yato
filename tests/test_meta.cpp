...
TEST(Yato_Meta, list)
{
    ...
    using l2 = typename yato::meta::list_push_front<double, l1>::type;
    using l3 = typename yato::meta::reverse_list<l2>::type;
    using l4 = typename yato::meta::list_push_back<l3, long>::type;
    ...
    using l5 = typename yato::meta::list_cat< yato::meta::list<int, short>, yato::meta::list<float, double> >::type;
    using l6 = typename yato::meta::list_cat< yato::meta::list<int, short>, yato::meta::null_list >::type;
    using l7 = typename yato::meta::list_cat< yato::meta::null_list, yato::meta::list<float, double> >::type;
