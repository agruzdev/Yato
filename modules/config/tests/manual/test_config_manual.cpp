...
TEST(Yato_Config, config_value)
{
    yato::conf::config_value v(static_cast<int64_t>(42));
    ...
    EXPECT_THROW(v.get<int32_t>(), yato::conf::config_error);
}

TEST(Yato_Config, manual_array)
{
    yato::conf::manual_array arr;
    arr.resize(3);
    arr.put(0, 10);
    arr.put(1, 20);
    arr.put(2, 30);
    ...
    yato::conf::manual_array arr2(arr);
    arr2.resize(4);
    arr2.put(3, 40);
    
    yato::conf::manual_array arr2d;
    arr2d.resize(3);
    arr2d.append(arr);
    arr2d.append(arr);
    arr2d.append(arr);
